...
* To save the webpage of the corresponding solution(s) found

While programming, it is quite often that we run into similar problems that we have encountered before. Yet, we might not always remember the solution (or where we found it) and go on searching for it again.
...
* The source code for this application was obtained from https://github.com/se-edu/addressbook-level4[Addressbook Level 4], and subsequently repackaged as a new application.
