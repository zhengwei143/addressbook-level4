...
* The index will be highlight only for certain commands required index.
* The prefix will be highlighted even it does not have space before, but it is valid or not depends on command validation.
====
