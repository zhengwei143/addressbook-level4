...
** Highlights: This command changes the way how issues are listed in the application. It needs efforts to combine sorting and filtering together properly and make sure the correct issue can be retrieved from the sorted list.

* *Minor enhancement*:
** Add the ability to set and reset primary solution. https://github.com/CS2103-AY1819S1-T12-4/main/pull/177[#177]
** Add a confirmation check for clear command. https://github.com/CS2103-AY1819S1-T12-4/main/pull/116[#116]
