...
==== Add issue
Adding a new issue can only happen at the issue level
...
Adding a new solution can only happen at the solution level
...
* **Alternative 1 (current choice):** Check the character that user input in the command box should be highlight.
...
* **Alternative 2:** Parse the user command simultaneously when user input.
