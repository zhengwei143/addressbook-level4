...
=== Sorting the list of issues

Format: `sort chro`

[TIP]
====
* Sort the issue list by their last modified time chronologically.
====
...
[TIP]
====
* Sort the issue list based on search frequency.
====
...
=== Refactoring tag: `(rt)refactorTag` [coming in v1.3]
