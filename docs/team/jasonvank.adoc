...
* *Minor enhancements*:
** Implement `command highlight` feature: Allows users to differentiate their inputs by highlighting command word, parameters and values in different colors.
** Implement `command alias` feature: Allows users to type command words less but achieve the same functionality.
** Refactor the application from AddressBook Level 4 to SaveIt app. https://github.com/CS2103-AY1819S1-T12-4/main/issues/30[#30] https://github.com/CS2103-AY1819S1-T12-4/main/pull/44[#44]
...
*** Improve Solution link validation （https://github.com/CS2103-AY1819S1-T12-4/main/pull/162/files [162] https://github.com/CS2103-AY1819S1-T12-4/main/pull/164[164])
