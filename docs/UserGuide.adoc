...
Changes the current editing directory to the root directory. Besides,
...
If their first tags are the same, the following tags are compared until there is a difference or one tag set comes to the end.
