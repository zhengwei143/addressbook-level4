...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Issue expectedIssue = new IssueBuilder(BOB).withTags(VALID_TAG_SYNTAX).build();
        ...
        assertParseSuccess(parser, STATEMENT_DESC_C + DESCRIPTION_DESC_C + SOLUTION_DESC_C
                + TAG_DESC_UI + CommandTestUtil.TAG_DESC_UI, new AddCommand(expectedIssueMultipleTags));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, STATEMENT_DESC_C + DESCRIPTION_DESC_C + VALID_SOLUTION_C,
                expectedMessage);
