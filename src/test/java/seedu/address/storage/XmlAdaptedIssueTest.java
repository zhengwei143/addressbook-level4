...
public class XmlAdaptedIssueTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        XmlAdaptedIssue person =
            new XmlAdaptedIssue(INVALID_NAME, VALID_DESCRIPTION, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        XmlAdaptedIssue person = new XmlAdaptedIssue(null, VALID_DESCRIPTION, VALID_TAGS);
    ...
    public void toModelType_invalidDescription_throwsIllegalValueException() {
        XmlAdaptedIssue person =
            new XmlAdaptedIssue(VALID_NAME, INVALID_DESCRIPTION, VALID_TAGS);
    ...
    public void toModelType_nullDescription_throwsIllegalValueException() {
        XmlAdaptedIssue person = new XmlAdaptedIssue(VALID_NAME, null, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        XmlAdaptedIssue person =
            new XmlAdaptedIssue(VALID_NAME, VALID_DESCRIPTION, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        XmlAdaptedIssue person = new XmlAdaptedIssue(VALID_NAME, VALID_DESCRIPTION, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        XmlAdaptedIssue person =
            new XmlAdaptedIssue(VALID_NAME, VALID_DESCRIPTION, invalidTags);
