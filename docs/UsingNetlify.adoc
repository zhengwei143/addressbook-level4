...
* View your main branch's deployed documentation on the site issue given by Netlify (customizable as shown <<Changing the site issue of your project, below>>).
+
image:netlify/temp_site_name.png[Temporary site issue, width = 630]
+
...
== Changing the site issue of your project
If you don't like the site issue given by Netlify, you can change it as follows:

. Click on `Settings`.
+
. Then click `Change site issue` and fill in your desired site issue.
+
image:netlify/change_site_name.png[Change site issue, width = 630]
