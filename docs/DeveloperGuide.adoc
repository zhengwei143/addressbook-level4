...
[discrete]
=== Use case: Add statement

*MSS*

1. User requests to add a new statement
2. User add statement in command line
3. User can choose add statement statement, multiple email links, remarks and tag.
...
[discrete]
=== Use case: Edit statement

*MSS*

1. User requests to list issues
2. SaveIt shows a list of issues
3. User requests to edit a specific statement in the list
4. SaveIt updates the statement
5. Use case ends.
