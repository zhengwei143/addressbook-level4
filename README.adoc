...
* The source code for this application was obtained from https://github.com/nus-cs2103-AY1819S1/addressbook-level4, and subsequently repackaged as a new application as https://github.com/CS2103-AY1819S1-T12-4/main[SaveIt].
