...
public class MainApp extends Application {
    ...
    /**
     * Returns a {@code ModelManager} with the data from {@code storage}'s saveit book and {@code userPrefs}. <br>
     * The data from the sample saveit book will be used instead if {@code storage}'s saveit book is not found,
